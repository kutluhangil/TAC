...
export const metadata: Metadata = {
  ...
  description:
    "TAÇ perde modelleri: stor, plise, ahşap jaluzi, metal jaluzi, rustik, zebra, dekoratif ray, tül, fon ve screen ofis perdesi. Yerinde ölçü ve montaj — Tuzla / İstanbul.",
};
...
export default function ModellerPage() {
  return (
    <div className="mx-auto max-w-6xl px-5 pb-24 pt-28 md:pt-32">
      <FadeUp>
        <p className="eyebrow">TAÇ Perde Modelleri</p>
